...
##---
  ...
  set.seed(225)
  n.sim <- 1
  blockSize <- 7  # number of acres per block (width & height)
  g.p <- list(
    # general
    ...
    # landscape
    lc.r=58,  # num rows in landscape
    lc.c=77,  # num columns in landscape
    ...
    # dispersal
    sdd.max=5,  # max dispersal distance (unit: cells)
    sdd.rate=0.2,  # 1/mn for dispersal kernel
